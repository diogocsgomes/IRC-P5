...
int main(int argc, char* argv[]) {
	...
	// PASSO 1
	// Atenção a estas variáveis (necessárias para usar threads)
...
void AtendeCliente(LPVOID param) { //PASSO 4 //Atenção ao parâmetro de entrada da função AtendeCliente
	...
	// PASSO 5
	// Não esquecer de fazer cast para SOCKET
	sock = (SOCKET)param;
