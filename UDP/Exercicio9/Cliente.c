...
Aguarda pela resposta (cadeia de carateres) um maximo de TIMEOUT segundos
e verifica a origem.
...
int main(int argc, char* argv[])
{
	...
	// VERSÃO 2
	//int response;
	//nbytes = recvfrom(sockfd, (char*)&response, sizeof(response), 0, (struct sockaddr*)&serv_addr, &tam);
	...
	ascii_value = '0' + atoi(buffer);
	printf("<CLI1>Mensagem recebida em formato ascii: %d\n", ascii_value);
